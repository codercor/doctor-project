...
const Sozlesmeler = () => {
    ...
    return (
        <div className="overflow-hidden md:bg-none bg-primary-light">
            ...
            <Container className=" h-[300px] md:h-[300px]  !w-full bg-cover bg-no-repeat md:!max-w-full bg-[left_calc(50%)_top_calc(20%)]  md:bg-cover bg-[url(/images/png/kullanimkurallari.jpeg)]">
