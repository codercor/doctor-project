...
import CerezContract from "@components/ContractContents/CerezContract";
import GizlilikContract from "@components/ContractContents/GizlilikContract";
...
const GizlilikSozlesmesi = () => {
    ...
    return (
        <div className="overflow-hidden md:bg-none bg-primary-light">
            <Head>
                <title> Çerez Politikası | Nazan Uysal Harzadın </title>
            ...
            <Container className=" h-[300px] md:h-[300px]  !w-full bg-cover bg-no-repeat md:!max-w-full bg-[left_calc(50%)_top_calc(45%)]    md:bg-cover bg-[url(/images/png/gizliliksozlesmesi.jpeg)]">
