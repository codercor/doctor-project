        ...
        <>
            ...
            <div className="flex flex-col  justify-center border-2 min-h-[150px] bg-[#F9F9F9] items-start px-[30px] gap-[30px]  w-[full]">
                ...
                <FormInputSelectOne
                    ...
                    onChange={handleChange}
                />{
                    values.examinationOfSymptomsDigestionQuestion40 === "evet" &&
                    <FormInputSelectOne
                ...
                <FormInputSelectOne
                    label="Diğer Büyümüş/Hassas"
                    name="anotherTest158"
                    options={HOS}
                    value={values.anotherTest158}
                    error={errors?.anotherTest158}
                    onChange={handleChange}
                />
                {
                    values.anotherTest158 != "yok" && values.anotherTest158 != "" && <>
                        <FormInputSelectOne
