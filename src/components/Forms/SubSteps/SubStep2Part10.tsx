...
export default function SubStep2Part10({
    ...
    return (
        <>
            ...
            <div className="flex flex-col  justify-center border-2 min-h-[150px] bg-[#F9F9F9] items-start px-[30px] gap-[30px]  w-[full]">
                ...
                />
                {
                    values.examinationOfSymptomsSkeletonQuestion12 != "yok" && values.examinationOfSymptomsSkeletonQuestion12 != "" && <>
                        <FormInputSelectOne
                ...
                <FormInputSelectOne
                    label="Zorluk"
                    name="examinationOfSymptomsNervesQuestion26"
                    options={HOS}
                    value={values.examinationOfSymptomsNervesQuestion26}
                    error={errors?.examinationOfSymptomsNervesQuestion26}
                    onChange={handleChange}
                />{
                    values.examinationOfSymptomsNervesQuestion26 != "yok" && values.examinationOfSymptomsNervesQuestion26 != "" && <>
                        <FormInputSelectOne
                            label="Konsantre olmada"
                ...
                <FormInputSelectOne
                    label="Gaz"
                    name="examinationOfSymptomsDigestionQuestion41"
                    options={HOS}
                    value={values.examinationOfSymptomsDigestionQuestion41}
                    error={errors?.examinationOfSymptomsDigestionQuestion41}
                    onChange={handleChange}
                />
                {
                    values.examinationOfSymptomsDigestionQuestion41 != "yok" && values.examinationOfSymptomsDigestionQuestion41 != "" &&
                    <>
                        <FormInputSelectOne
                            label="Karnın alt bölümünde"
                ...
                <FormInputSelectOne
                    label="İntolerans"
                    name="examinationOfSymptomsDigestionQuestion39"
                    options={HOS}
                    value={values.examinationOfSymptomsDigestionQuestion39}
                    error={errors?.examinationOfSymptomsDigestionQuestion39}
                    onChange={handleChange}
                />
                {
                    values.examinationOfSymptomsDigestionQuestion39 != "yok" && values.examinationOfSymptomsDigestionQuestion39 != "" && <>
                        <FormInputSelectOne
                            label="Laktoz"
                ...
                <FormInputSelectOne
                    label="Karaciğer hastalığı/sarılık"
                    name="examinationOfSymptomsDigestionQuestion40"
                    options={HOS}
                    value={values.examinationOfSymptomsDigestionQuestion40}
                    error={errors?.examinationOfSymptomsDigestionQuestion40}
                    onChange={handleChange}
                />{
                    values.examinationOfSymptomsDigestionQuestion40 != "yok" && values.examinationOfSymptomsDigestionQuestion40 != "" &&
                    <FormInputSelectOne
                        label="Sarı gözler ve cilt"
                ...
                <FormInputSelectOne
                    ...
                    name="anotherTest160"
                    options={HOS}
                    value={values.anotherTest160}
                    error={errors?.anotherTest160}
                    onChange={handleChange}
                />
                {
                    values.anotherTest160 != "yok" && values.anotherTest160 != "" && <>
                        <FormInputSelectOne
                            label="İlkbahar"
                            name="anotherTest16"
                            options={HOS}
                ...
                <FormInputSelectOne
                    ...
                    name="anotherTest159"
                    options={HOS}
                    value={values.anotherTest159}
                    error={errors?.anotherTest159}
                    onChange={handleChange}
                />
                {
                    values.anotherTest159 != "yok" && values.anotherTest159 != "" && <>
                        <FormInputSelectOne
                            label="El tırnakları"
                            name="anotherTest40"
                            options={HOS}
                ...
                <FormInputSelectOne
                    ...
                    name="anotherTest154"
                    options={HOS}
                    value={values.anotherTest154}
                    error={errors?.anotherTest154}
                    onChange={handleChange}
                />{
                    values.anotherTest154 != "yok" && values.anotherTest154 != "" && <>
                        <FormInputSelectOne
                            label="çatlak var mı?"
                            name="anotherTest46"
                            options={HOS}
                ...
                <FormInputSelectOne
                    ...
                    name="anotherTest155"
                    options={HOS}
                    value={values.anotherTest155}
                    error={errors?.anotherTest155}
                    onChange={handleChange}
                />{
                    values.anotherTest155 != "yok" && values.anotherTest155 != "" && <>
                        <FormInputSelectOne
                            label="Kontrol dışı durum var mı?"
                            name="anotherTest48"
                            options={HOS}
                ...
                <FormInputSelectOne
                    ...
                    name="anotherTest156"
                    options={HOS}
                    value={values.anotherTest156}
                    error={errors?.anotherTest156}
                    onChange={handleChange}
                />
                {
                    values.anotherTest156 != "yok" && values.anotherTest156 != "" && <>
                        <FormInputSelectOne
                            label="Çatlama var mı ?"
                            name="anotherTest49"
                            options={HOS}
                ...
                <FormInputSelectOne
                    ...
                    name="anotherTest157"
                    options={HOS}
                    value={values.anotherTest157}
                    error={errors?.anotherTest157}
                    onChange={handleChange}
                />{values.anotherTest157 != "yok" && values.anotherTest157 != "" && <>
                    <FormInputSelectOne
                        label="Kepek var mı?"
                        name="anotherTest52"
                        options={HOS}
...

                {
                    patientGender === "Kadın" && <>
                        ...
                        <FormInputSelectOne
                            ...
                            name="anotherTest161"
                            options={HOS}
                            value={values.anotherTest161}
                            error={errors?.anotherTest161}
                            onChange={handleChange}
                        />{
                            values.anotherTest161 != "yok" && values.anotherTest161 != "" && <>
                        ...
                        <FormInputSelectOne
                            ...
                            name="anotherTest162"
                            options={HOS}
                            value={values.anotherTest162}
                            error={errors?.anotherTest162}
                            onChange={handleChange}
                        />
                        {
                            values.anotherTest162 != "yok" && values.anotherTest162 != "" && <>
            ...
            <p className="text-[#4E929D] text-[16px] font-nexa-bold mt-2">
...
const AKN = ({ values, handleChange }: { values: any, handleChange: any }) => {
    return (<div className="w-full flex flex-col font-nexa-regular min-h-[200px]">
...
const STK = ({ values, handleChange }: { values: any, handleChange: any }) => {
    return (<div className="w-full flex flex-col font-nexa-regular min-h-[210px]">
        <table className="table-auto w-full  row-span-4 col-span-1">
            <thead className="table-header-group text-left">
                <tr className="table-row border-2">
                    <th> </th>
