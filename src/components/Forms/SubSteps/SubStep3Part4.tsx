            ...
            <div
                ...
                <div className="w-full flex">
                    <div
                        ...
                        {generateForm(Sections[9], values, errors, handleChange)}
                    </div>
                    <div
                        className="flex flex-col gap-[20px] py-[5px] mb-[5px] bg-[#F9F9F9] items-center px-[20px] w-full">
                        {generateForm(Sections[10], values, errors, handleChange)}
                    </div>
                </div>
                <div className="w-full flex">
                    <div
                        className="flex flex-col gap-[20px] py-[5px] mb-[5px] bg-[#F9F9F9] items-center px-[20px] w-full">
                        {generateForm(Sections[11], values, errors, handleChange)}
                    </div>
                    <div
                        className="flex flex-col gap-[20px] py-[5px] mb-[5px] bg-[#F9F9F9] items-center px-[20px] w-full">
                        {generateForm(Sections[12], values, errors, handleChange)}
                    </div>
                ...
                <div className="w-full flex">
                    <div
                        className="flex flex-col gap-[20px] py-[5px] mb-[5px] bg-[#F9F9F9] items-center px-[20px] w-full">
                        {generateForm(Sections[13], values, errors, handleChange)}
                    </div>
                    <div
                        className="flex flex-col gap-[20px] py-[5px] mb-[5px] bg-[#F9F9F9] items-center px-[20px] w-full">
                        {generateForm(Sections[14], values, errors, handleChange)}
                    </div>
                </div>
