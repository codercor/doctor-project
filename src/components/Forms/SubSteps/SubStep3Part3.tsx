...
export default function SubStep3Part3({
                                          errors,
                                          values,
                                          handleChange,
                                          setFieldValue
            ...
            <div
                ...
                <div className="w-full flex">
                    <div
                        ...
                        {generateForm(Sections[6], values, errors, handleChange)}
                    </div>
                    <div
                        className="flex flex-col gap-[20px] py-[5px] mb-[5px] bg-[#F9F9F9] items-center px-[20px] w-full">
                        {generateForm(Sections[7], values, errors, handleChange)}
                    </div>
                    <div
                        className="flex flex-col gap-[20px] py-[5px] mb-[5px] bg-[#F9F9F9] items-center px-[20px] w-full">
                        {generateForm(Sections[8], values, errors, handleChange)}
                    </div>
                </div>
            </div>
        </>
