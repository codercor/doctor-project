...
export default function Form2Footer({active, setter, parts}: Props) {
    ...
    return (
        <div
            className="min-h-[112px] my-[10px] w-full px-[40px] rounded-[20px_5px] p-2 flex bg-[#E9EDD9]  text-[#5B623D] items-center justify-between">
              ...
              />
                        ...
                        {![2, parts].includes(active + 1) && (
                            <Button
                                ...
                                onClick={(e) => {
                                    e.preventDefault();
                                    setter(active < parts ? active + 1 : parts - 1)
                                }}
                            />
                        )}
