    ...
    return (
        <div>
            ...
            <h1 className='text-2xl font-nexa-bold'>
                ...
                AÇIK RIZA ONAY METNİ</h1>

            <p>  6698 sayılı “Kişisel Verilerin Korunması Kanunu” gereğince, tarafıma Dr. NAZAN UYSAL HAZARDIN internet sitesi ve Muayenehane bünyesinde ilgili yasal düzenlemeler ve bu çerçevede sahip olduğum haklar açısından tarafıma bilgi verilmiş olup, tarafıma teslim edilen aydınlatma metnini okudum, inceledim.  İlgili Yasalar kapsamında Dr. NAZAN UYSAL HAZARDIN internet sitesi ve Muayenehane ne tarafımca sözlü/ yazılı ve/veya elektronik ortamda verilen, kimliğimi belirleyen veya belirlemeye yarayanlar da dahil olmak üzere gerekli kişisel verilerimin, özel nitelikli kişisel verilerimin, sağlık verilerimin Dr. NAZAN UYSAL HAZARDIN internet sitesi ve Muayenehane tarafından işlenmesine, yapılan iş gereğince hizmetin verilebilmesi ve bu hizmetlerin planlaması amacıyla, ilgili mevzuatlar kapsamında paylaşımın gerekli olduğu diğer kişi ve kuruluşlar ile paylaşılmasına; kişisel veriler, özel nitelikli kişisel veriler, sağlık verilerimin 6698 sayılı “Kişisel Verilerin Korunması Kanununda” tanımlanan kapsamda aşağıda detayları verilen kişisel ve özel nitelikli kişisel verilerin işlenmesine muvafakat ediyorum.
            </p>
