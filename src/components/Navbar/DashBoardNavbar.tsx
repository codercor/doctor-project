...
const DashBoardNavbar = () => <div className="md:min-h-[160px] flex items-center justify-between bg-cover bg-[url(/images/png/panel-navbar.png)] rounded-[20px_5px_20px_5px] px-[32px]">
    <div className="w-[289px] h-[97px] bg-opacity-80 bg-secondary flex items-center  gap-[10px] pl-[20px] rounded-[20px_5px_20px_5px]" >
        ...
        <div>
            ...
            <Text className="text-[white] text-[14px] font-nexa-light">Selami Şahin</Text>
        </div>
    </div>
