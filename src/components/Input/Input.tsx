...
const Input = ({ min, max, text, type = "text", placeholder = "", inputClassName = "", value = undefined, onChange = () => { }, onBlur = () => { }, onKeyUp = () => { }, name = "", disabled = false }: InputProps) => {
    ...
    return <div className="flex flex-col w-full  leading-none">
        ...
        <div className="relative w-full">
            <input onKeyUp={onKeyUp} disabled={disabled} name={name}
                {...minMaxForNumber}
